    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutoresLibros", x => new { x.BookId, x.AuthorId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibrosReservas", x => new { x.BookId, x.ReserveId });
                    table.ForeignKey(
                        name: "FK_LibrosReservas_Libros_BookId",
                        column: x => x.BookId,
                        principalTable: "Libros",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LibrosReservas_Reservas_ReserveId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutoresLibros_AuthorId",
                table: "AutoresLibros",
                column: "AuthorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LibrosReservas_ReserveId",
                table: "LibrosReservas",
                column: "ReserveId");
